...
// Combines structs and vectors with range-based for loops,
// const references, auto type deduction, object initialization,
// member access, and modifying vs read-only access.
